...
API_ID = int(environ.get('API_ID', '12942504'))
API_HASH = environ.get('API_HASH', '9a307f9b719ed56bb5c1bebf5398e33a')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002008973008'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5392115802').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002012160361').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001935978642') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://japnaambaba2:MNJ9Ty39F1kyKnPq@cluster0.sk7au6x.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "techjautobot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'techjcollection')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'VLC_PLAY') # owner username without @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'Rb9AVzYe7Cb3aZcdZ5iE8Ij98Fw2')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'Rb9AVzYe7Cb3aZcdZ5iE8Ij98Fw2')
